...
class CommentsController{
    ...
    public function getAllCommentsByEntryId($id){
        $getAllComment = $this->db->prepare("SELECT * FROM comments WHERE entryID = :id");
        $getAllComment->execute([":id" => $id]);
        return $getAllComment->fetchAll();
    }
